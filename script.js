document.addEventListener('DOMContentLoaded', () => {
        ...
        filteredGames.forEach(game => {
            ...
            card.innerHTML = `
                ...
                <div class="game-meta">
                    ...
                    ${game.decks > 1 ? `<div class="meta-tag" title="Requires ${game.decks} decks"><img src="card-back.svg" class="card-back-icon" alt="Decks">x${game.decks}</div>` : ''}
                </div>
    ...
    function openModal(game) {
        modalBody.innerHTML = `
            ...
            ${game.decks > 1 ? `<div class="meta-tag" style="display:inline-block; margin-bottom: 1rem; margin-left: 0.5rem;" title="Requires ${game.decks} decks"><img src="card-back.svg" class="card-back-icon" alt="Decks">x${game.decks}</div>` : ''}
